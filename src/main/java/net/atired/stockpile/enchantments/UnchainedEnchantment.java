...
public class UnchainedEnchantment extends Enchantment {
    public UnchainedEnchantment(EquipmentSlot[] slotTypes) {
    ...
    public boolean canAccept(Enchantment other) {
        return super.canAccept(other) && other != ArsenalEnchantments.REELING  && other != StockpileEnchantmentInit.WHIRLING;
    }
